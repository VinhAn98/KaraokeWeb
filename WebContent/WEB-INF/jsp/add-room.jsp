...
<body>
	...
	<main>
		<div class="container">
				content
			<form:form action="room/${inforoom.getIdroom()}" method="post" modelAttribute="inforoom">
				...
				<div class="form-group">
					...
					<form:input type="text" class="form-control" id="People"
						path='people' />
				</div>
				<div class="form-group">
					<label for="GuestNumber">Guest Number:</label>
					<form:input type="text" class="form-control" id="GuestNumber"
						path='guestnumber' />
				</div>
